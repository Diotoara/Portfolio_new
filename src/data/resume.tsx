...
export const DATA = {
  ...
  contact: {
    ...
    social: {
      ...
      LinkedIn: {
        name: "LinkedIn",
        url: "https://www.linkedin.com/in/aryan-jha-530719325/",
        icon: Icons.linkedin,
      ...
      X: {
        name: "X",
        url: "https://x.com/Dio204817144633",
        icon: Icons.x,
  ...
  education: [
    ...
    },
    {
      ...
      href: "https://www.vandanainternationalschool.in/",
